INSERT INTO bb2_api.supplier(iduser, username, password, type, name, country)
 VALUES (bb2_api.user_seq.nextval, 'prueba', 'prueba', 2, 'Pepe Juan', 'España');
INSERT INTO bb2_api.supplier(iduser, username, password, type, name, country)
VALUES (bb2_api.user_seq.nextval, 'prueba2', 'prueba2',2, 'Zurita', 'España');
INSERT INTO bb2_api.supplier(iduser, username, password, type, name, country)
VALUES (bb2_api.user_seq.nextval, 'prueba3', 'prueba3',2, 'All In One', 'España');
INSERT INTO bb2_api.supplier(iduser, username, password, type, name, country)
VALUES (bb2_api.user_seq.nextval, 'prueba4', 'prueba4',2, 'SML', 'Filandia');
