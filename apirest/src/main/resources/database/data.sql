INSERT INTO bb2_api.supplier(iduser, username, password, name, country)
 VALUES (bb2_api.user_seq.nextval, 'prueba', '$2a$10$DIgASOccRVFWGmIufjkmXeQDFFsPgZ1WOyUN9uRZPNo6wC8iIuln6',
  2,'Pepe Juan', 'España');
INSERT INTO bb2_api.supplier(iduser, username, password, name, country)
VALUES (bb2_api.user_seq.nextval, 'prueba2', '$2a$10$DIgASOccRVFWGmIufjkmXeQDFFsPgZ1WOyUN9uRZPNo6wC8iIuln6',
2, 'Zurita', 'España');
INSERT INTO bb2_api.supplier(iduser, username, password, name, country)
VALUES (bb2_api.user_seq.nextval, 'prueba3', '$2a$10$DIgASOccRVFWGmIufjkmXeQDFFsPgZ1WOyUN9uRZPNo6wC8iIuln6',
2, 'All In One', 'España');
INSERT INTO bb2_api.supplier(iduser, username, password, name, country)
VALUES (bb2_api.user_seq.nextval, 'prueba4', '$2a$10$DIgASOccRVFWGmIufjkmXeQDFFsPgZ1WOyUN9uRZPNo6wC8iIuln6',
2, 'SML', 'Filandia');
